...
class CartaDesastre:
    def __init__(self, nombreImagen, color):
        self.nombreImagen = nombreImagen
        self.color = color
...
class Player:
    ...
    def __init__(self, dinosaurio):
        ...
        if self.dinosaurio == Player.TRICERATOPS:
            self.colorBonus[2] = 1
            self.colorBonus[1] = -1
        elif self.dinosaurio == Player.REX:
            self.colorBonus[0] = 1
            self.colorBonus[2] = -1
        elif self.dinosaurio == Player.BRONTO:
            self.colorBonus[1] = 1
            self.colorBonus[0] = -1
        elif self.dinosaurio == Player.STEGO:
            self.colorBonus[3] = 1
...
class Round:
    ...
    #def ObtenerGanadoresPartida(self):
...
"""
Falta la función de obtener los ganadores de la partida al final de cada ronda        
"""